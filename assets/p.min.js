...
let setAnswer = (target) => {
  target.children.length === 1
    ? results.push(target.children[0].firstElementChild.innerText)
    : results.push(target.innerText)
}
      ...
      setTimeout(function () {
        ...
        jQuery('#p_modal_button3').on('click', function (e) {
          ...
          e.stopPropagation(),
            ...
            // stepfinal(),
            console.log(
              `USER ANSWERS: Genero: ${results[0]};  Idade: ${results[1]};  Familia: ${results[2]};  Ja comprei: ${results[3]}`
            )
